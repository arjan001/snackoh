							...
							<div class="table-top table-top-new">
								...
								<div class="search-path d-flex align-items-center search-path-new">
									<div class="d-flex">
										...
										<a href="department-list.html" class="btn-list active"><i data-feather="list" class="feather-user"></i></a>
										<a href="department-grid.html" class="btn-grid"><i data-feather="grid" class="feather-user"></i></a>
									</div>
									<div class="form-sort">
