					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									<li class="active"><a href="employees-grid.html"><i data-feather="user"></i><span>Employees</span></a></li>
				...
				<div class="content">
					<div class="page-header">
						...
						<ul class="table-top-head">
							<li>
								<div class="page-btn">
									<a href="employees-list.html" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Employee List</a>
								</div>
							</li>
							<li>
