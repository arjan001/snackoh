				...
				<div class="page-header">
					<div class="add-item d-flex">
						<div class="page-title">
							<h4>New Fleet</h4>
							<h6>Create new Fleet</h6>
						</div>
					</div>
					<ul class="table-top-head">
						<li>
							<div class="page-btn">
								<a href="fleet-manage.php" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Fleet</a>
							</div>
						</li>
						<li>
				...
				<form action="add-product.html">
					...
					<div class="col-lg-12">
						<div class="btn-addproduct mb-4">
							...
							<button type="submit" class="btn btn-submit">Save Fleet</button>
						</div>
					</div>
				</form>
			<!-- /add -->
