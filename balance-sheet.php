						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="active"><a href="profit-and-loss.html"><i data-feather="pie-chart"></i><span>Profit & Loss</span></a></li>
								</ul>
							</li>															
							<li class="submenu-open">
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="report" aria-labelledby="set-tab3">
								...
								<li><a href="profit-and-loss.html" class="active"><span>Profit & Loss</span></a></li>
							</ul>
