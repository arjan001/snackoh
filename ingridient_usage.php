					...
					<div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4>INGRIDIENT USAGE</h4>
								<h6>VIEW YOUR INGRIDIENT TIMELY USAGE</h6>
							</div>							
						</div>
...
<table class="table datanew">
    ...
    <tbody>
        <tr>
            ...
            <td>45 kg</td>
            <td>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ingredientUsageModal">
                    View Details
                </button>
            </td>
        </tr>
...
<!-- Ingredient Breakdown Modal -->
 <div class="modal fade" id="ingredientUsageModal" tabindex="-1" aria-labelledby="ingredientUsageModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ingredientUsageModalLabel">Ingredient Usage Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <h6>Recipe-wise Ingredient Usage</h6>
                <table class="table">
                    <thead>
                        <tr>
                            <th>Recipe</th>
                ...
                <h6>Adjust Ingredient Consumption</h6>
                <form>
                    <div class="mb-3">
                        <label for="adjustQuantity" class="form-label">Adjust Quantity Used</label>
                        <input type="number" class="form-control" id="adjustQuantity" placeholder="Enter new quantity">
                    </div>
