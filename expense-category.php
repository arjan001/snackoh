			...
			<div class="page-wrapper">
				<div class="content">
					<div class="page-header">
						...
						<div class="page-btn">
							<a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add_expense_category"><i data-feather="plus-circle" class="me-2"></i> Add Expense Category</a>
						</div>
					</div>
										...
										<tr >
											...
											<td class="action-table-data">
												<div class="edit-delete-action">
													<a class="me-2 p-2 mb-0" data-bs-toggle="modal" data-bs-target="#edit_expense_category">
						...
						<div class="content">
							...
							<div class="modal-body custom-modal-body">
								...
								<div class="modal-footer-btn">
									...
									<a href="expense-category.html" class="btn btn-submit">Save Changes</a>
								</div>
							</div>
						</div>
					</div>
