							...
							<div class="table-top table-top-two table-top-new">
								...
								<div class="search-path d-flex align-items-center search-path-new">
									<div class="d-flex">
										...
										<a href="employees-list.html" class="btn-list"><i data-feather="list" class="feather-user"></i></a>
										<a href="employees-grid.html" class="btn-grid active"><i data-feather="grid" class="feather-user"></i></a>
									</div>
										...
										<div class="profile-head-action">
											...
											<div class="dropdown profile-action">
												...
												<ul class="dropdown-menu">
													<li>
														<a href="edit-employee.html" class="dropdown-item"><i data-feather="edit" class="info-img"></i>Edit</a>
													</li>
													<li>
