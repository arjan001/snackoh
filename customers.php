					...
					<div class="table-tab">
						<ul class="nav nav-pills" id="pills-tab" role="tablist">
							<li class="nav-item" role="presentation">
							  <button class="nav-link active" id="customer-tab" data-bs-toggle="pill" data-bs-target="#customer" type="button" role="tab" aria-controls="customer" aria-selected="true">Customers List</button>
							</li>


							<li class="nav-item" role="presentation">
							  <button class="nav-link" id="geoMapping-tab" data-bs-toggle="pill" data-bs-target="#geoMapping" type="button" role="tab" aria-controls="geoMapping" aria-selected="false">Geo Mapping</button>
							</li>


							<li class="nav-item" role="presentation">
							  <button class="nav-link" id="segmentation-tab" data-bs-toggle="pill" data-bs-target="#segmentation" type="button" role="tab" aria-controls="segmentation" aria-selected="false">Segmentation</button>
							</li>

							<li class="nav-item" role="presentation">
							  <button class="nav-link" id="engagementTerms-tab" data-bs-toggle="pill" data-bs-target="#engagementTerms" type="button" role="tab" aria-controls="engagementTerms" aria-selected="false">Engagement Terms</button>
							</li>
...
?>
					...
					<!--CUSTOMERS LIST TAB  -->
						...
						<div class="col-xl-3 col-sm-6 col-12">
                           ...
                           <!--SEGMENTATION TAB  -->
						<div class="tab-pane fade" id="engagementTerms" role="tabpanel" aria-labelledby="engagementTerms-tab">
