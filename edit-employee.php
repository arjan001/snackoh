									...
									<div class="col-lg-4 col-md-6">
										<div class="input-blocks">
											...
											<div class="input-groupicon calender-input">
												<i data-feather="calendar" class="info-img"></i>
												<input type="text" class="datetimepicker form-control"
													placeholder="Select Date" name="joining_date"required>
											</div>
										</div>
									</div>
										...
										<div class="mb-3">
											...
											<select name="designation_id" class="select"required>
												...
												<?php while ($row = $designations->fetch_assoc()): ?>
													<option value="<?= $row['id'] ?>"><?= $row['designation_name'] ?>
													</option>
												<?php endwhile; ?>
											</select>
										</div>
									...
									<div class="row">
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												...
												<input type="text" class="form-control" name='emergency_no_1'required>
											</div>
										</div>
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="form-label">Emergency No 2</label>
												<input type="text" class="form-control" name="emergency_no_2"required>
											</div>
										</div>
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
