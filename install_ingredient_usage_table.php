...
echo "<h2>Installing Ingredient Usage Tracking Table...</h2>";
...
try {
    ...
    echo "</ul>";
    echo "<p><a href='pos.php'>Go to POS</a> | <a href='manage-stocks.php'>View Stock</a> | <a href='product-list.php'>View Products</a></p>";
