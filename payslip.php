						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="submenu">
										<a href="payroll-list.html" class="subdrop active"><i data-feather="dollar-sign"></i><span>Payroll</span><span class="menu-arrow"></span></a>
										<ul>
											<li><a href="payroll-list.html">Employee Salary</a></li>
											<li><a href="payslip.html" class="active">Payslip</a></li>
										</ul>
									</li>
								</ul>
							</li>
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="employee" aria-labelledby="set-tab2">
								...
								<li class="submenu">
									<a href="payroll-list.html" class="active subdrop"><span>Payroll</span><span class="menu-arrow"></span></a>
									<ul>
										<li><a href="payroll-list.html">Employee Salary</a></li>
										<li><a href="payslip.html" class="active">Payslip</a></li>
									</ul>
