					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									<li class="active"><a href="sales-report.html"><i data-feather="bar-chart-2"></i><span>Sales Report</span></a></li>
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="report" aria-labelledby="set-tab3">
								<li><a href="sales-report.html" class="active"><span>Sales Report</span></a></li>
